...
//     wp_register_script( 'jquery', '/js/jquery-3.2.1.slim.min.js');
//     wp_enqueue_script( 'jquery' );
//
//     wp_deregister_script( 'bootstrap' );
//     wp_register_script( 'bootstrap', '/js/bootstrap.min.js');
//     wp_enqueue_script( 'bootstrap' );
//
//     wp_deregister_script( 'fontawesome' );
//     wp_register_script( 'fontawesome', '/js/fontawesome-js-all.js');
//     wp_enqueue_script( 'fontawesome' );
//
//     wp_deregister_script( 'popper' );
//     wp_register_script( 'popper', '/js/popper.min.js');
//     wp_enqueue_script( 'popper' );
// }
// add_action('wp_enqueue_scripts', 'add_jquery_script');

function mi_funcion_ejemplo() {
  wp_enqueue_script(
    'mi-script-ejemplo',
...
function add_fontawesome() {
  wp_enqueue_script(
    'fontawesome',
    get_template_directory_uri() . '/js/fontawesome-js-all.js',
    array('jquery'),
    '1',
    true
  );
...
add_action('wp_enqueue_scripts', 'mi_funcion_ejemplo');
add_action('wp_enqueue_scripts', 'add_bootstrap');
add_action('wp_enqueue_scripts', 'add_fontawesome');
add_action('wp_enqueue_scripts', 'add_popper');
add_action('wp_enqueue_scripts', 'add_vue');
...
function carga_estilos_theme(){
  wp_register_style( 'estilos',
    get_template_directory_uri() . '/css/style.css',array(),'1.1','all' );
  wp_enqueue_style( 'estilos' );
  wp_register_style( 'bootstrap',
    get_template_directory_uri() . '/css/bootstrap.css',array(),'1.1','all' );
  wp_enqueue_style( 'bootstrap' );
  wp_register_style( 'bootstrapmap',
    get_template_directory_uri() . '/css/bootstrap.min.css.map',array(),'1.1','all' );
